...
<div class="api-endpoint">
	<div class="endpoint-data">
		...
		<h6>/wp-json/wc/v1/products/reviews</h6>
	</div>
</div>
...
```shell
curl -X POST https://example.com/wp-json/wc/v1/products/reviews \
...
Payhere.post("products/reviews", data)
  .then((response) => {
...
print_r($payhere->post('products/reviews', $data));
?>
```
...
payhere.post("products/reviews", data).parsed_response
```
...
```json
{
	...
	"_links": {
		"self": [
			{
				"href": "https://example.com/wp-json/wc/v1/products/reviews/22"
			}
		],
		"collection": [
			{
				"href": "https://example.com/wp-json/wc/v1/products/reviews"
			}
		],
		"up": [
			{
...
<div class="api-endpoint">
	<div class="endpoint-data">
		...
		<h6>/wp-json/wc/v1/products/reviews/&lt;id&gt;</h6>
	</div>
</div>

```shell
curl https://example.com/wp-json/wc/v1/products/reviews/22 \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.get("products/reviews/22")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```php
<?php print_r($payhere->get('products/reviews/22')); ?>
```
...
```ruby
payhere.get("products/reviews/22").parsed_response
```
...
```shell
curl https://example.com/wp-json/wc/v1/products/reviews \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.get("products/reviews")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```php
<?php print_r($payhere->get('products/reviews')); ?>
```
...
```ruby
payhere.get("products/reviews").parsed_response
```
...
[
	...
	},
	{
		...
		"_links": {
			"self": [
				{
					"href": "https://example.com/wp-json/wc/v1/products/reviews/20"
				}
			],
			"collection": [
				{
			...
			"up": [
				{
					"href": "https://example.com/wp-json/wc/v1/products/31"
				}
			],
			"reviewer": [
				{
...
```shell
curl -X PUT https://example.com/wp-json/wc/v1/products/reviews/20 \
	-u consumer_key:consumer_secret \
	-H "Content-Type: application/json" \
	-d '{
  "rating": 5
...
Payhere.put("products/reviews/20", data)
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
print_r($payhere->put('products/reviews/20', $data));
?>
```
...
payhere.put("products/reviews/20", data).parsed_response
```
...
<div class="api-endpoint">
	<div class="endpoint-data">
		...
		<h6>/wp-json/wc/v1/products/review/&lt;id&gt;</h6>
	</div>
</div>

```shell
curl -X DELETE https://example.com/wp-json/wc/v1/products/review/34?force=true \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.delete("products/review/20", {
  force: true
})
  .then((response) => {
    console.log(response.data);
...
```php
<?php print_r($payhere->delete('products/reviews/20', ['force' => true])); ?>
```
...
```ruby
payhere.delete("products/review/20", force: true).parsed_response
```
...
<div class="api-endpoint">
	<div class="endpoint-data">
		<i class="label label-post">POST</i>
		<h6>/wp-json/wc/v1/products/reviews/batch</h6>
	</div>
</div>

```shell
curl -X POST https://example.com//wp-json/wc/v1/products/reviews/batch \
	-u consumer_key:consumer_secret \
	-H "Content-Type: application/json" \
	-d '{
  "create": [
...
Payhere.post("products/reviews/batch", data)
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
print_r($payhere->post('products/reviews/batch', $data));
?>
```
...
payhere.post("products/reviews/batch", data).parsed_response
```
	...
	"create": [
		{
			...
			"_links": {
				"self": [
					{
						"href": "https://example.com/wp-json/wc/v1/products/reviews/25"
					}
				],
				"collection": [
					{
		...
		},
		{
			...
			"_links": {
				"self": [
					{
						"href": "https://example.com/wp-json/wc/v1/products/reviews/26"
					}
				],
				"collection": [
					{
	...
	"update": [
		{
			...
			"_links": {
				"self": [
					{
						"href": "https://example.com/wp-json/wc/v1/products/reviews/7"
					}
				],
				"collection": [
					{
				...
				"up": [
					{
						"href": "https://example.com/wp-json/wc/v1/products/66"
					}
				]
			}
		}
