...
<div class="api-endpoint">
	<div class="endpoint-data">
		...
		<h6>/wp-json/wc/v1/payment_gateways/&lt;id&gt;</h6>
	</div>
</div>

```shell
curl https://example.com/wp-json/wc/v1/payment_gateways/bacs \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.get("payment_gateways/bacs")
  .then((response) => {
...
```php
<?php print_r($payhere->get('payment_gateways/bacs')); ?>
```
...
```ruby
payhere.get("payment_gateways/bacs").parsed_response
```
...
```json
{
  ...
  "_links": {
    "self": [
      {
        "href": "https://example.com/wp-json/wc/v1/payment_gateways/bacs"
      }
    ],
    "collection": [
      {
        "href": "https://example.com/wp-json/wc/v1/payment_gateways"
      }
    ]
  }
}
...
<div class="api-endpoint">
	<div class="endpoint-data">
		<i class="label label-get">GET</i>
		<h6>/wp-json/wc/v1/payment_gateways</h6>
	</div>
</div>

```shell
curl https://example.com/wp-json/wc/v1/payment_gateways \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.get("payment_gateways")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```php
<?php print_r($payhere->get('payment_gateways')); ?>
```
...
```ruby
payhere.get("payment_gateways").parsed_response
```
...
[
  ...
  },
  {
    ...
    "_links": {
      "self": [
        {
          "href": "https://example.com/wp-json/wc/v1/payment_gateways/cheque"
        }
      ],
      "collection": [
        {
  ...
  },
  {
    ...
    "_links": {
      "self": [
        {
          "href": "https://example.com/wp-json/wc/v1/payment_gateways/cod"
        }
      ],
      "collection": [
        {
  ...
  },
  {
    ...
    "settings": {
      ...
      "debug": {
        ...
        "description": "Log PayPal events, such as IPN requests, inside <code>/var/www/payhere/wp-content/uploads/wc-logs/paypal-de01f7c6894774e7ac8e4207bb8bac2f.log</code>",
        "type": "checkbox",
        "value": "yes",
        "default": "no",
        "tip": "Log PayPal events, such as IPN requests, inside <code>/var/www/payhere/wp-content/uploads/wc-logs/paypal-de01f7c6894774e7ac8e4207bb8bac2f.log</code>",
        "placeholder": ""
      },
      "receiver_email": {
        "id": "receiver_email",
    ...
    "_links": {
      "self": [
        {
          "href": "https://example.com/wp-json/wc/v1/payment_gateways/paypal"
        }
      ],
      "collection": [
        {
...
```shell
curl -X PUT https://example.com/wp-json/wc/v1/payment_gateways/bacs \
	-u consumer_key:consumer_secret \
...
Payhere.put("payment_gateways/bacs", data)
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
print_r($payhere->put('payment_gateways/bacs', $data));
?>
```
...
payhere.put("payment_gateways/bacs", data).parsed_response
```
