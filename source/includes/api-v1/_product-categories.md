...
Payhere.post("products/categories", data)
  .then((response) => {
...
```javascript
Payhere.get("products/categories/9")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```javascript
Payhere.get("products/categories")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
Payhere.put("products/categories/9", data)
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```javascript
Payhere.delete("products/categories/9", {
  force: true
})
  .then((response) => {
    console.log(response.data);
...
```php
<?php print_r($payhere->delete('products/categories/9', ['force' => true])); ?>
```
...
```ruby
payhere.delete("products/categories/9", force: true).parsed_response
```
...
Payhere.post("products/categories/batch", data)
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
print_r($payhere->post('products/categories/batch', $data));
?>
```
...
payhere.post("products/categories/batch", data).parsed_response
```
