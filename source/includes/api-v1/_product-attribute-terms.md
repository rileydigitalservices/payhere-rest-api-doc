...
Payhere.post("products/attributes/2/terms", data)
  .then((response) => {
...
print_r($payhere->post('products/attributes/2/terms', $data));
?>
```
...
payhere.post("products/attributes/2/terms", data).parsed_response
```
...
```javascript
Payhere.get("products/attributes/2/terms/23")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```php
<?php print_r($payhere->get('products/attributes/2/terms/23')); ?>
```
...
```ruby
payhere.get("products/attributes/2/terms/23").parsed_response
```
...
```javascript
Payhere.get("products/attributes/2/terms")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```php
<?php print_r($payhere->get('products/attributes/2/terms')); ?>
```
...
```ruby
payhere.get("products/attributes/2/terms").parsed_response
```
...
Payhere.put("products/attributes/2/terms/23", data)
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
print_r($payhere->put('products/attributes/2/terms/23', $data));
?>
```
...
payhere.put("products/attributes/2/terms/23", data).parsed_response
```
...
```javascript
Payhere.delete("products/attributes/2/terms/23", {
  force: true
})
  .then((response) => {
    console.log(response.data);
...
```php
<?php print_r($payhere->delete('products/attributes/2/terms/23', ['force' => true])); ?>
```
...
```ruby
payhere.delete("products/attributes/2/terms/23", force: true).parsed_response
```
...
Payhere.post("products/attributes/2/terms/batch", data)
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
print_r($payhere->post('products/attributes/2/terms/batch', $data));
?>
```
...
payhere.post("products/attributes/2/terms/batch", data).parsed_response
```
