...
curl -X POST https://example.com/wp-json/wc/v1/products \
  ...
  "images": [
    {
      "src": "http://demo.woothemes.com/payhere/wp-content/uploads/sites/56/2013/06/T_2_front.jpg"
    },
    {
      "src": "http://demo.woothemes.com/payhere/wp-content/uploads/sites/56/2013/06/T_2_back.jpg"
    }
  ]
}'
```
...
```json
{
  ...
  "price_html": "<span class=\"payhere-Price-amount amount\"><span class=\"payhere-Price-currencySymbol\">&#36;</span>21.99</span>",
  "on_sale": false,
  "purchasable": true,
  "total_sales": 0,
  "virtual": false,
  ...
  "_links": {
    "self": [
      {
        "href": "https://example.com/wp-json/wc/v1/products/794"
      }
    ],
    "collection": [
      {
...
curl -X POST https://example.com/wp-json/wc/v1/products \
  ...
  "images": [
    {
      "src": "http://demo.woothemes.com/payhere/wp-content/uploads/sites/56/2013/06/T_4_front.jpg"
    },
    {
      "src": "http://demo.woothemes.com/payhere/wp-content/uploads/sites/56/2013/06/T_4_back.jpg"
    },
    {
      "src": "http://demo.woothemes.com/payhere/wp-content/uploads/sites/56/2013/06/T_3_front.jpg"
    },
    {
      "src": "http://demo.woothemes.com/payhere/wp-content/uploads/sites/56/2013/06/T_3_back.jpg"
    }
  ],
  "attributes": [
    {
...
```json
{
  ...
  "_links": {
    "self": [
      {
        "href": "https://example.com/wp-json/wc/v1/products/799"
      }
    ],
    "collection": [
      {
...
```shell
curl https://example.com/wp-json/wc/v1/products/794 \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.get("products/794")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```php
<?php print_r($payhere->get('products/794')); ?>
```
...
```ruby
payhere.get("products/794").parsed_response
```
...
```shell
curl -X PUT https://example.com/wp-json/wc/v1/products/794 \
	-u consumer_key:consumer_secret \
	-H "Content-Type: application/json" \
	-d '{
  "regular_price": "24.54"
...
print_r($payhere->put('products/794', $data));
?>
```
...
payhere.put("products/794", data).parsed_response
```
...
```json
{
  ...
  "date_on_sale_to": null,
  "date_on_sale_to_gmt": null,
  "price_html": "<span class=\"payhere-Price-amount amount\"><span class=\"payhere-Price-currencySymbol\">&#36;</span>24.54</span>",
  "on_sale": false,
  "purchasable": true,
  "total_sales": 0,
  "virtual": false,
...
```shell
curl -X DELETE https://example.com/wp-json/wc/v1/products/794?force=true \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.delete("products/794", {
  force: true
})
  .then((response) => {
    console.log(response.data);
...
```php
<?php print_r($payhere->delete('products/794', ['force' => true])); ?>
```
...
```ruby
payhere.delete("products/794", force: true).parsed_response
```
  ...
  "create": [
    {
      ...
      "downloads": [
        {
          "name": "Woo Single",
          "file": "http://demo.woothemes.com/payhere/wp-content/uploads/sites/56/2013/06/cd_4_angle.jpg"
        }
      ],
      "categories": [
        {
      ...
      "images": [
        {
          "src": "http://demo.woothemes.com/payhere/wp-content/uploads/sites/56/2013/06/cd_4_angle.jpg"
        }
      ]
    },
    {
...
Payhere.post("products/batch", data)
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
print_r($payhere->post('products/batch', $data));
?>
```
...
payhere.post("products/batch", data).parsed_response
```
  ...
  "create": [
    {
      ...
      "_links": {
        "self": [
          {
            "href": "https://example.com/wp-json/wc/v1/products/801"
          }
        ],
        "collection": [
          {
    ...
    },
    {
      ...
      "_links": {
        "self": [
          {
            "href": "https://example.com/wp-json/wc/v1/products/804"
          }
        ],
        "collection": [
          {
