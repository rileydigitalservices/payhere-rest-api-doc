...
<div class="api-endpoint">
	<div class="endpoint-data">
		...
		<h6>/wc-api/v1/taxes</h6>
	</div>
</div>

```shell
curl -X POST https://example.com/wc-api/v1/taxes \
...
Payhere.post('taxes', data, function(err, data, res) {
  console.log(res);
});
```
...
print_r($payhere->post('taxes', $data));
?>
```
...
payhere.post("taxes", data).parsed_response
```
...
<div class="api-endpoint">
	<div class="endpoint-data">
		...
		<h6>/wc-api/v1/taxes/&lt;id&gt;</h6>
	</div>
</div>

```shell
curl https://example.com/wc-api/v1/taxes/53 \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.get('taxes/53', function(err, data, res) {
  console.log(res);
});
```

```php
<?php print_r($payhere->get('taxes/53')); ?>
```
...
```ruby
payhere.get("taxes/53").parsed_response
```
...
```shell
curl https://example.com/wc-api/v1/taxes \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.get('taxes', function(err, data, res) {
  console.log(res);
});
```

```php
<?php print_r($payhere->get('taxes')); ?>
```
...
```ruby
payhere.get("taxes").parsed_response
```
...
```shell
curl -X PUT https://example.com/wc-api/v1/taxes/53 \
	-u consumer_key:consumer_secret \
	-H "Content-Type: application/json" \
	-d '{
  "tax": {
...
Payhere.put('taxes/53', data, function(err, data, res) {
  console.log(res);
});
```
...
print_r($payhere->put('taxes/53', $data));
?>
```
...
payhere.put("taxes/53", data).parsed_response
```
...
```shell
curl -X POST https://example.com/wc-api/v1/taxes/bulk \
	-u consumer_key:consumer_secret \
	-H "Content-Type: application/json" \
	-d '{
  "taxes": [
...
Payhere.post('taxes/bulk', data, function(err, data, res) {
  console.log(res);
});
```
...
print_r($payhere->post('taxes/bulk', $data));
?>
```
...
payhere.post("taxes/bulk", data).parsed_response
```
...
```shell
curl -X DELETE https://example.com/wc-api/v1/taxes/53 \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.delete('taxes/53', function(err, data, res) {
  console.log(res);
});
```

```php
<?php print_r($payhere->delete('taxes/53')); ?>
```
...
```ruby
payhere.delete("taxes/53").parsed_response
```
...
<div class="api-endpoint">
	<div class="endpoint-data">
		<i class="label label-get">GET</i>
		<h6>/wc-api/v1/taxes/count</h6>
	</div>
</div>

```shell
curl https://example.com/wc-api/v1/taxes/count \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.get('taxes/count', function(err, data, res) {
  console.log(res);
});
```
...
```ruby
payhere.get("taxes/count").parsed_response
```
