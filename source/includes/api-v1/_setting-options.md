...
<div class="api-endpoint">
	<div class="endpoint-data">
		...
		<h6>/wp-json/wc/v1/settings/&lt;group_id&gt;/&lt;id&gt;</h6>
	</div>
</div>

```shell
curl https://example.com/wp-json/wc/v1/settings/general/payhere_allowed_countries \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.get("settings/general/payhere_allowed_countries")
  .then((response) => {
...
```php
<?php print_r($payhere->get('settings/general/payhere_allowed_countries')); ?>
```

```python
print(wcapi.get("settings/general/payhere_allowed_countries").json())
```

```ruby
payhere.get("settings/general/payhere_allowed_countries").parsed_response
```
...
```json
{
	...
	"_links": {
		"self": [
			{
				"href": "https://example.com/wp-json/wc/v1/settings/general/payhere_allowed_countries"
			}
		],
		"collection": [
			{
...
<div class="api-endpoint">
	<div class="endpoint-data">
		<i class="label label-get">GET</i>
		<h6>/wp-json/wc/v1/settings/&lt;id&gt;</h6>
	</div>
</div>

```shell
curl https://example.com/wp-json/wc/v1/settings/general \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.get("settings/general")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```php
<?php print_r($payhere->get('settings/general')); ?>
```
...
```ruby
payhere.get("settings/general").parsed_response
```
...
[
  ...
  {
    "id": "payhere_all_except_countries",
    ...
    "_links": {
      "self": [
        {
          "href": "https://example.com/wp-json/wc/v1/settings/general/payhere_all_except_countries"
        }
      ],
      "collection": [
        {
  ...
  {
    "id": "payhere_specific_allowed_countries",
    ...
    "_links": {
      "self": [
        {
          "href": "https://example.com/wp-json/wc/v1/settings/general/payhere_specific_allowed_countries"
        }
      ],
      "collection": [
        {
  ...
  },
  {
    ...
    "_links": {
      "self": [
        {
          "href": "https://example.com/wp-json/wc/v1/settings/general/payhere_ship_to_countries"
        }
      ],
      "collection": [
        {
  ...
  {
    "id": "payhere_specific_ship_to_countries",
    ...
    "_links": {
      "self": [
        {
          "href": "https://example.com/wp-json/wc/v1/settings/general/payhere_specific_ship_to_countries"
        }
      ],
      "collection": [
        {
  ...
  {
    "id": "payhere_default_customer_address",
    ...
    "_links": {
      "self": [
        {
          "href": "https://example.com/wp-json/wc/v1/settings/general/payhere_default_customer_address"
        }
      ],
      "collection": [
        {
  ...
  },
  {
    ...
    "_links": {
      "self": [
        {
          "href": "https://example.com/wp-json/wc/v1/settings/general/payhere_calc_taxes"
        }
      ],
      "collection": [
        {
  ...
  },
  {
    ...
    "_links": {
      "self": [
        {
          "href": "https://example.com/wp-json/wc/v1/settings/general/payhere_demo_store"
        }
      ],
      "collection": [
        {
  ...
  },
  {
    ...
    "_links": {
      "self": [
        {
          "href": "https://example.com/wp-json/wc/v1/settings/general/payhere_demo_store_notice"
        }
      ],
      "collection": [
        {
  ...
  },
  {
    ...
    "_links": {
      "self": [
        {
          "href": "https://example.com/wp-json/wc/v1/settings/general/payhere_currency"
        }
      ],
      "collection": [
        {
  ...
  },
  {
    ...
    "_links": {
      "self": [
        {
          "href": "https://example.com/wp-json/wc/v1/settings/general/payhere_currency_pos"
        }
      ],
      "collection": [
        {
  ...
  },
  {
    ...
    "_links": {
      "self": [
        {
          "href": "https://example.com/wp-json/wc/v1/settings/general/payhere_price_thousand_sep"
        }
      ],
      "collection": [
        {
  ...
  },
  {
    ...
    "_links": {
      "self": [
        {
          "href": "https://example.com/wp-json/wc/v1/settings/general/payhere_price_decimal_sep"
        }
      ],
      "collection": [
        {
  ...
  },
  {
    ...
    "_links": {
      "self": [
        {
          "href": "https://example.com/wp-json/wc/v1/settings/general/payhere_price_num_decimals"
        }
      ],
      "collection": [
        {
...
```shell
curl -X PUT https://example.com/wp-json/wc/v1/settings/general/payhere_allowed_countries \
	-u consumer_key:consumer_secret \
...
Payhere.put("settings/general/payhere_allowed_countries", data)
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
print_r($payhere->put('settings/general/payhere_allowed_countries', $data));
?>
```
...
print(wcapi.put("settings/general/payhere_allowed_countries", data).json())
```
...
payhere.put("settings/general/payhere_allowed_countries", data).parsed_response
```
...
<div class="api-endpoint">
	<div class="endpoint-data">
		...
		<h6>/wp-json/wc/v1/settings/&lt;id&gt;/batch</h6>
	</div>
</div>

```shell
curl -X POST https://example.com/wp-json/wc/v1/settings/general/batch \
	-u consumer_key:consumer_secret \
	-H "Content-Type: application/json" \
	-d '{
  "update": [
...
Payhere.post("products/22/settings/general/batch", data)
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
print_r($payhere->post('products/22/settings/general/batch', $data));
?>
```
...
payhere.post("products/22/settings/general/batch", data).parsed_response
```
