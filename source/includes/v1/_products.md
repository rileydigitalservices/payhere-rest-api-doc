...
| `type`                          | string  | Product type. By default in Payhere the following types are available: `simple`, `grouped`, `external`, `variable`. Default is `simple`                                                                                                                      |
...
| `attributes`                    | array   | List of product attributes. See [Attributes Properties](#attributes-properties). Note: the attribute must be registered in Payhere before.                                                                                                                   |
...
<aside class="notice">
	<code>menu_order</code> attribute is available starting from Payhere 2.5.
</aside>
...
<aside class="notice">
	<code>alt</code> and <code>title</code> attributes are writable starting from Payhere 2.5.
</aside>
...
```shell
curl -X POST https://example.com/wc-api/v1/products \
...
Payhere.post('products', data, function(err, data, res) {
  console.log(res);
});
```
...
print_r($payhere->post('products', $data));
?>
```
...
payhere.post("products", data).parsed_response
```
...
<div class="api-endpoint">
	<div class="endpoint-data">
		...
		<h6>/wc-api/v1/products/&lt;id&gt;</h6>
	</div>
</div>

```shell
curl https://example.com/wc-api/v1/products/546 \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.get('products/546', function(err, data, res) {
  console.log(res);
});
```

```php
<?php print_r($payhere->get('products/546')); ?>
```
...
```ruby
payhere.get("products/546").parsed_response
```
...
```shell
curl https://example.com/wc-api/v1/products \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.get('products', function(err, data, res) {
  console.log(res);
});
```

```php
<?php print_r($payhere->get('products')); ?>
```
...
```ruby
payhere.get("products").parsed_response
```
...
<aside class="notice">
	<code>tag</code>, <code>shipping_class</code> and <code>pa_*</code> filters are available starting from Payhere 2.5.
</aside>
...
```shell
curl -X PUT https://example.com/wc-api/v1/products/546 \
	-u consumer_key:consumer_secret \
	-H "Content-Type: application/json" \
	-d '{
  "product": {
...
Payhere.put('products/546', data, function(err, data, res) {
  console.log(res);
});
```
...
print_r($payhere->put('products/546', $data));
?>
```
...
payhere.put("products/546", data).parsed_response
```
...
<div class="api-endpoint">
	<div class="endpoint-data">
		<i class="label label-post">POST</i>
		<h6>/wc-api/v1/products/bulk</h6>
	</div>
</div>

```shell
curl -X POST https://example.com/wc-api/v1/products/bulk \
	-u consumer_key:consumer_secret \
	-H "Content-Type: application/json" \
	-d '{
  "products": [
...
Payhere.post('products/bulk', data, function(err, data, res) {
  console.log(res);
});
```
...
print_r($payhere->post('products/bulk', $data));
?>
```
...
payhere.post("products/bulk", data).parsed_response
```
...
```shell
curl -X DELETE https://example.com/wc-api/v1/products/546?force=true \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.delete('products/546?force=true', function(err, data, res) {
  console.log(res);
});
```

```php
<?php print_r($payhere->delete('products/546', ['force' => true])); ?>
```
...
```ruby
payhere.delete("products/546, force: true).parsed_response
```
...
<div class="api-endpoint">
	<div class="endpoint-data">
		<i class="label label-get">GET</i>
		<h6>/wc-api/v1/products/count</h6>
	</div>
</div>

```shell
curl https://example.com/wc-api/v1/products/count \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.get('products/count', function(err, data, res) {
  console.log(res);
});
```

```php
<?php print_r($payhere->get('products/count')); ?>
```
...
```ruby
payhere.get("products/count").parsed_response
```
...
<div class="api-endpoint">
	<div class="endpoint-data">
		<i class="label label-get">GET</i>
		<h6>/wc-api/v1/products/&lt;id&gt;/orders</h6>
	</div>
</div>

```shell
curl https://example.com/wc-api/v1/products/546/orders \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.get('products/546/orders', function(err, data, res) {
  console.log(res);
});
```

```php
<?php print_r($payhere->get('products/546/orders')); ?>
```
...
```ruby
payhere.get("products/546/orders").parsed_response
```
...
<div class="api-endpoint">
	<div class="endpoint-data">
		<i class="label label-get">GET</i>
		<h6>/wc-api/v1/products/&lt;id&gt;/reviews</h6>
	</div>
</div>

```shell
curl https://example.com/wc-api/v1/products/546/reviews \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.get('products/546/reviews', function(err, data, res) {
  console.log(res);
});
```

```php
<?php print_r($payhere->get('products/546/reviews')); ?>
```
...
```ruby
payhere.get("products/546/reviews").parsed_response
```
