...
<div class="api-endpoint">
	<div class="endpoint-data">
		...
		<h6>/wp-json/wc/v1/shipping/zones/&lt;id&gt;/methods</h6>
	</div>
</div>
...
```shell
curl -X POST https://example.com/wp-json/wc/v1/shipping/zones/5/methods \
...
Payhere.post("shipping/zones/5/methods", data)
  .then((response) => {
...
print_r($payhere->post('shipping/zones/5/methods', $data));
?>
```
...
payhere.post("shipping/zones/5/methods", data).parsed_response
```
...
```json
{
  ...
  "_links": {
    "self": [
      {
        "href": "https://example.com/wp-json/wc/v1/shipping/zones/5/methods/26"
      }
    ],
    "collection": [
      {
        "href": "https://example.com/wp-json/wc/v1/shipping/zones/5/methods"
      }
    ],
    "describes": [
      {
...
<div class="api-endpoint">
	<div class="endpoint-data">
		...
		<h6>/wp-json/wc/v1/shipping/zones/&lt;zone_id&gt;/methods/&lt;id&gt;</h6>
	</div>
</div>

```shell
curl https://example.com/wp-json/wc/v1/shipping/zones/5/methods/26 \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.get("shipping/zones/5/methods/26")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```php
<?php print_r($payhere->get('shipping/zones/5/methods/26')); ?>
```
...
```ruby
payhere.get("shipping/zones/5/methods/26").parsed_response
```
...
```shell
curl https://example.com/wp-json/wc/v1/shipping/zones/5/methods \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.get("shipping/zones/5/methods")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```php
<?php print_r($payhere->get('shipping/zones/5/methods')); ?>
```
...
```ruby
payhere.get("shipping/zones/5/methods").parsed_response
```
...
[
  ...
  },
  {
    ...
    "_links": {
      "self": [
        {
          "href": "https://example.com/wp-json/wc/v1/shipping/zones/5/methods/27"
        }
      ],
      "collection": [
        {
...
```shell
curl -X PUT https://example.com/wp-json/wc/v1/shipping/zones/5/methods/26 \
	-u consumer_key:consumer_secret \
	-H "Content-Type: application/json" \
	-d '{
  "settings": {
...
Payhere.put("shipping/zones/5/methods/26", data)
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
print_r($payhere->put('shipping/zones/5/methods/26', $data));
?>
```
...
payhere.put("shipping/zones/5/methods/26", data).parsed_response
```
...
```shell
curl -X DELETE https://example.com/wp-json/wc/v1/shipping/zones/5/methods/26?force=true \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.delete("shipping/zones/5/methods/26", {
  force: true
})
  .then((response) => {
    console.log(response.data);
...
```php
<?php print_r($payhere->delete('shipping/zones/5/methods/26', ['force' => true])); ?>
```
...
```ruby
payhere.delete("shipping/zones/5/methods/26", force: true).parsed_response
```
