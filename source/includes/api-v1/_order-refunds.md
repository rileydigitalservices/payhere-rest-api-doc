...
```shell
curl -X POST https://example.com/wp-json/wc/v1/orders/723/refunds \
...
Payhere.post("orders/723/refunds", data)
  .then((response) => {
...
print_r($payhere->post('orders/723/refunds', $data));
?>
```
...
payhere.post("orders/723/refunds", data).parsed_response
```
...
```json
{
  ...
  "_links": {
    "self": [
      {
        "href": "https://example.com/wp-json/wc/v1/orders/723/refunds/726"
      }
    ],
    "collection": [
      {
        "href": "https://example.com/wp-json/wc/v1/orders/723/refunds"
      }
    ],
    "up": [
      {
...
```shell
curl https://example.com/wp-json/wc/v1/orders/723/refunds/726 \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.get("orders/723/refunds/726")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```php
<?php print_r($payhere->get('orders/723/refunds/726')); ?>
```
...
```ruby
payhere.get("orders/723/refunds/726").parsed_response
```
...
```shell
curl https://example.com/wp-json/wc/v1/orders/723/refunds \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.get("orders/723/refunds")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```php
<?php print_r($payhere->get('orders/723/refunds')); ?>
```
...
```ruby
payhere.get("orders/723/refunds").parsed_response
```
...
[
  ...
  },
  {
    ...
    "_links": {
      "self": [
        {
          "href": "https://example.com/wp-json/wc/v1/orders/723/refunds/724"
        }
      ],
      "collection": [
        {
...
```shell
curl -X DELETE https://example.com/wp-json/wc/v1/orders/723/refunds/726?force=true \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.delete("orders/723/refunds/726", {
  force: true
})
  .then((response) => {
    console.log(response.data);
...
```php
<?php print_r($payhere->delete('orders/723/refunds/726', ['force' => true])); ?>
```
...
```ruby
payhere.delete("orders/723/refunds/726", force: true).parsed_response
```
