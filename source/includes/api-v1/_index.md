...
```json
{
  ...
  "routes": {
    ...
    "/wc/v1/products/attributes/batch": {
      ...
      "_links": {
        "self": "https://example.com/wp-json/wc/v1/products/attributes/batch"
      }
    },
    ...
    "/wc/v1/products/(?P<product_id>[\\d]+)/reviews/batch": {
      "namespace": "wc/v3",
      "methods": [
        "POST",
        "PUT",
    ...
    "/wc/v1/products/(?P<product_id>[\\d]+)/variations": {
      "namespace": "wc/v3",
      "methods": [
        "GET",
        "POST"
    ...
    "/wc/v1/products/(?P<product_id>[\\d]+)/variations/(?P<id>[\\d]+)": {
      "namespace": "wc/v3",
      "methods": [
        "GET",
        "POST",
    ...
    "/wc/v1/products/(?P<product_id>[\\d]+)/variations/batch": {
      "namespace": "wc/v3",
      "methods": [
        "POST",
        "PUT",
    ...
    "/wc/v1/settings": {
      ...
      "_links": {
        "self": "https://example.com/wp-json/wc/v1/settings"
      }
    },
    "/wc/v1/settings/(?P<group_id>[\\w-]+)": {
      "namespace": "wc/v3",
      "methods": [
        "GET"
      ],
    ...
    "/wc/v1/settings/(?P<group_id>[\\w-]+)/batch": {
      "namespace": "wc/v3",
      "methods": [
        "POST",
        "PUT",
    ...
    "/wc/v1/settings/(?P<group_id>[\\w-]+)/(?P<id>[\\w-]+)": {
      "namespace": "wc/v3",
      "methods": [
        "GET",
        "POST",
    ...
    "/wc/v1/shipping/zones": {
      ...
      "_links": {
        "self": "https://example.com/wp-json/wc/v1/shipping/zones"
      }
    },
    "/wc/v1/shipping/zones/(?P<id>[\\d-]+)": {
      "namespace": "wc/v3",
      "methods": [
        "GET",
        "POST",
    ...
    "/wc/v1/shipping/zones/(?P<id>[\\d-]+)/locations": {
      "namespace": "wc/v3",
      "methods": [
        "GET",
        "POST",
    ...
    "/wc/v1/shipping/zones/(?P<zone_id>[\\d-]+)/methods": {
      "namespace": "wc/v3",
      "methods": [
        "GET",
        "POST"
    ...
    "/wc/v1/shipping/zones/(?P<zone_id>[\\d-]+)/methods/(?P<instance_id>[\\d-]+)": {
      "namespace": "wc/v3",
      "methods": [
        "GET",
        "POST",
    ...
    "/wc/v1/system_status": {
      ...
      "_links": {
        "self": "https://example.com/wp-json/wc/v1/system_status"
      }
    },
    "/wc/v1/system_status/tools": {
      "namespace": "wc/v3",
      "methods": [
        "GET"
      ],
      ...
      "_links": {
        "self": "https://example.com/wp-json/wc/v1/system_status/tools"
      }
    },
    "/wc/v1/system_status/tools/(?P<id>[\\w-]+)": {
      "namespace": "wc/v3",
      "methods": [
        "GET",
        "POST",
    ...
    "/wc/v1/shipping_methods": {
      ...
      "_links": {
        "self": "https://example.com/wp-json/wc/v1/shipping_methods"
      }
    },
    "/wc/v1/shipping_methods/(?P<id>[\\w-]+)": {
      "namespace": "wc/v3",
      "methods": [
        "GET"
      ],
    ...
    "/wc/v1/payment_gateways": {
      ...
      "_links": {
        "self": "https://example.com/wp-json/wc/v1/payment_gateways"
      }
    },
    "/wc/v1/payment_gateways/(?P<id>[\\w-]+)": {
      "namespace": "wc/v3",
      "methods": [
        "GET",
        "POST",
