...
<div class="api-endpoint">
	<div class="endpoint-data">
		...
		<h6>/wc-api/v1/coupons</h6>
	</div>
</div>

```shell
curl -X POST https://example.com/wc-api/v1/coupons \
...
Payhere.post('coupons', data, function(err, data, res) {
  console.log(res);
});
```
...
print_r($payhere->post('coupons', $data));
?>
```
...
payhere.post("coupons", data).parsed_response
```
...
<div class="api-endpoint">
	<div class="endpoint-data">
		...
		<h6>/wc-api/v1/coupons/&lt;id&gt;</h6>
	</div>
</div>

```shell
curl https://example.com/wc-api/v1/coupons/529 \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.get('coupons/529', function(err, data, res) {
  console.log(res);
});
```

```php
<?php print_r($payhere->get('coupons/529')); ?>
```
...
```ruby
payhere.get("coupons/529").parsed_response
```
...
```shell
curl https://example.com/wc-api/v1/coupons \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.get('coupons', function(err, data, res) {
  console.log(res);
});
```

```php
<?php print_r($payhere->get('coupons')); ?>
```
...
```ruby
payhere.get("coupons").parsed_response
```
...
```shell
curl -X PUT https://example.com/wc-api/v1/coupons/529 \
	-u consumer_key:consumer_secret \
	-H "Content-Type: application/json" \
	-d '{
  "coupon": {
...
Payhere.put('coupons/529', data, function(err, data, res) {
  console.log(res);
});
```
...
print_r($payhere->put('coupons/529', $data)); 
?>
```
...
payhere.put("coupons/529", data).parsed_response
```
...
<div class="api-endpoint">
	<div class="endpoint-data">
		<i class="label label-post">POST</i>
		<h6>/wc-api/v1/coupons/bulk</h6>
	</div>
</div>

```shell
curl -X POST https://example.com/wc-api/v1/coupons/bulk \
	-u consumer_key:consumer_secret \
	-H "Content-Type: application/json" \
	-d '{
  "coupons": [
...
Payhere.post('coupons/bulk', data, function(err, data, res) {
  console.log(res);
});
```
...
print_r($payhere->post('coupons/bulk', $data)); 
?>
```
...
payhere.post("coupons/bulk", data).parsed_response
```
...
```shell
curl -X DELETE https://example.com/wc-api/v1/coupons/529/?force=true \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.delete('coupons/529/?force=true', function(err, data, res) {
  console.log(res);
});
```

```php
<?php print_r($payhere->delete('coupons/529', ['force' => true])); ?>
```
...
```ruby
payhere.delete("coupons/529", force: true).parsed_response
```
...
<div class="api-endpoint">
	<div class="endpoint-data">
		<i class="label label-get">GET</i>
		<h6>/wc-api/v1/coupons/count</h6>
	</div>
</div>

```shell
curl https://example.com/wc-api/v1/coupons/count \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.get('coupons/count', function(err, data, res) {
  console.log(res);
});
```

```php
<?php print_r($payhere->get('coupons/count')); ?>
```
...
```ruby
payhere.get("coupons/count").parsed_response
```
