...
```shell
curl -X POST https://example.com/wc-api/v1/orders \
...
Payhere.post('orders', data, function(err, data, res) {
  console.log(res);
});
```
...
print_r($payhere->post('orders', $data));
?>
```
...
payhere.post("orders", data).parsed_response
```
...
<div class="api-endpoint">
	<div class="endpoint-data">
		...
		<h6>/wc-api/v1/orders/&lt;id&gt;</h6>
	</div>
</div>

```shell
curl https://example.com/wc-api/v1/orders/645 \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.get('orders/645', function(err, data, res) {
  console.log(res);
});
```

```php
<?php print_r($payhere->get('orders/645')); ?>
```
...
```ruby
payhere.get("orders/645").parsed_response
```
...
<aside class="notice">
	<code>expand</code> filter is available starting from Payhere 2.5.
</aside>
...
```shell
curl https://example.com/wc-api/v1/orders \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.get('orders', function(err, data, res) {
  console.log(res);
});
```

```php
<?php print_r($payhere->get('orders')); ?>
```
...
```ruby
payhere.get("orders").parsed_response
```
...
```shell
curl -X PUT https://example.com/wc-api/v1/orders/645 \
	-u consumer_key:consumer_secret \
	-H "Content-Type: application/json" \
	-d '{
  "order": {
...
Payhere.put('orders/645', data, function(err, data, res) {
  console.log(res);
});
```
...
print_r($payhere->put('orders/645', $data));
?>
```
...
payhere.put("orders/645", data).parsed_response
```
...
<div class="api-endpoint">
	<div class="endpoint-data">
		<i class="label label-post">POST</i>
		<h6>/wc-api/v1/orders/bulk</h6>
	</div>
</div>

```shell
curl -X POST https://example.com/wc-api/v1/orders/bulk \
	-u consumer_key:consumer_secret \
	-H "Content-Type: application/json" \
	-d '{
  "orders": [
...
Payhere.post('orders/bulk', data, function(err, data, res) {
  console.log(res);
});
```
...
print_r($payhere->post('orders/bulk', $data));
?>
```
...
payhere.post("orders/bulk", data).parsed_response
```
...
```shell
curl -X DELETE https://example.com/wc-api/v1/orders/645/?force=true \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.delete('orders/645/?force=true', function(err, data, res) {
  console.log(res);
});
```

```php
<?php print_r($payhere->delete('orders/645', ['force' => true])); ?>
```
...
```ruby
payhere.delete("orders/645/", force: true).parsed_response
```
...
<div class="api-endpoint">
	<div class="endpoint-data">
		<i class="label label-get">GET</i>
		<h6>/wc-api/v1/orders/count</h6>
	</div>
</div>

```shell
curl https://example.com/wc-api/v1/orders/count \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.get('orders/count', function(err, data, res) {
  console.log(res);
});
```

```php
<?php print_r($payhere->get('orders/count')); ?>
```
...
```ruby
payhere.get("orders/count").parsed_response
```
...
<div class="api-endpoint">
	<div class="endpoint-data">
		<i class="label label-get">GET</i>
		<h6>/wc-api/v1/orders/statuses</h6>
	</div>
</div>

```shell
curl https://example.com/wc-api/v1/orders/statuses \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.get('orders/statuses', function(err, data, res) {
  console.log(res);
});
```

```php
<?php print_r($payhere->get('orders/statuses')); ?>
```
...
```ruby
payhere.get("orders/statuses").parsed_response
```
