...
```php
<?php print_r($payhere->get('taxes/72')); ?>
```
...
```ruby
payhere.get("taxes/72").parsed_response
```
...
print_r($payhere->put('taxes/72', $data));
?>
```
...
payhere.put("taxes/72", data).parsed_response
```
...
```php
<?php print_r($payhere->delete('taxes/72', ['force' => true])); ?>
```
...
```ruby
payhere.delete("taxes/72", force: true).parsed_response
```
...
print_r($payhere->post('taxes/batch', $data));
?>
```
...
payhere.post("taxes/batch", data).parsed_response
```
