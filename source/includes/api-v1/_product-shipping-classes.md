...
Payhere.post("products/shipping_classes", data)
  .then((response) => {
...
```javascript
Payhere.get("products/shipping_classes/32")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```php
<?php print_r($payhere->get('products/shipping_classes/32')); ?>
```
...
```ruby
payhere.get("products/shipping_classes/32").parsed_response
```
...
```javascript
Payhere.get("products/shipping_classes")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
Payhere.put("products/shipping_classes/32", data)
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
print_r($payhere->put('products/shipping_classes/32', $data));
?>
```
...
payhere.put("products/shipping_classes/32", data).parsed_response
```
...
```javascript
Payhere.delete("products/shipping_classes/32", {
  force: true
})
  .then((response) => {
    console.log(response.data);
...
```php
<?php print_r($payhere->delete('products/shipping_classes/32', ['force' => true])); ?>
```
...
```ruby
payhere.delete("products/shipping_classes/32", force: true).parsed_response
```
...
Payhere.post("products/shipping_classes/batch", data)
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
print_r($payhere->post('products/shipping_classes/batch', $data));
?>
```
...
payhere.post("products/shipping_classes/batch", data).parsed_response
```
