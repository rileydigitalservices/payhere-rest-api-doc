...
<div class="api-endpoint">
	<div class="endpoint-data">
		...
		<h6>/wp-json/wc/v1/products/&lt;product_id&gt;/variations</h6>
	</div>
</div>
...
```shell
curl -X POST https://example.com/wp-json/wc/v1/products/22/variations \
...
Payhere.post("products/22/variations", data)
  .then((response) => {
...
print_r($payhere->post('products/22/variations', $data));
?>
```
...
payhere.post("products/22/variations", data).parsed_response
```
...
```json
{
  ...
  "_links": {
    "self": [
      {
        "href": "https://example.com/wp-json/wc/v1/products/22/variations/732"
      }
    ],
    "collection": [
      {
        "href": "https://example.com/wp-json/wc/v1/products/22/variations"
      }
    ],
    "up": [
      {
        "href": "https://example.com/wp-json/wc/v1/products/22"
      }
    ]
  }
}
...
<div class="api-endpoint">
	<div class="endpoint-data">
		...
		<h6>/wp-json/wc/v1/products/&lt;product_id&gt;/variations/&lt;id&gt;</h6>
	</div>
</div>

```shell
curl https://example.com/wp-json/wc/v1/products/22/variations/732 \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.get("products/22/variations/732")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```php
<?php print_r($payhere->get('products/22/variations/732')); ?>
```
...
```ruby
payhere.get("products/22/variations/732").parsed_response
```
...
```shell
curl https://example.com/wp-json/wc/v1/products/22/variations \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.get("products/22/variations")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```php
<?php print_r($payhere->get('products/22/variations')); ?>
```
...
```ruby
payhere.get("products/22/variations").parsed_response
```
...
[
  {
    ...
    "_links": {
      "self": [
        {
          "href": "https://example.com/wp-json/wc/v1/products/22/variations/733"
        }
      ],
      "collection": [
        {
...
```shell
curl -X PUT https://example.com/wp-json/wc/v1/products/22/variations/733 \
	-u consumer_key:consumer_secret \
	-H "Content-Type: application/json" \
	-d '{
  "regular_price": "10.00"
...
Payhere.put("products/22/variations/733", data)
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
print_r($payhere->put('products/22/variations/733', $data));
?>
```
...
payhere.put("products/22/variations/733", data).parsed_response
```
...
```shell
curl -X DELETE https://example.com/wp-json/wc/v1/products/22/variations/733?force=true \
	-u consumer_key:consumer_secret
```

```javascript
Payhere.delete("products/22/variations/733", {
  force: true
})
  .then((response) => {
    console.log(response.data);
...
```php
<?php print_r($payhere->delete('products/22/variations/733', ['force' => true])); ?>
```
...
```ruby
payhere.delete("products/22/variations/733", force: true).parsed_response
```
...
<div class="api-endpoint">
	<div class="endpoint-data">
		<i class="label label-post">POST</i>
		<h6>/wp-json/wc/v1/products/&lt;product_id&gt;/variations/batch</h6>
	</div>
</div>

```shell
curl -X POST https://example.com/wp-json/wc/v1/products/22/variations/batch \
	-u consumer_key:consumer_secret \
	-H "Content-Type: application/json" \
	-d '{
  "create": [
...
Payhere.post("products/22/variations/batch", data)
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
print_r($payhere->post('products/22/variations/batch', $data));
?>
```
...
payhere.post("products/22/variations/batch", data).parsed_response
```
  ...
  "create": [
    {
      ...
      "image": {
        ...
        "src": "https://example.com/wp-content/plugins/payhere/assets/images/placeholder.png",
        "name": "Placeholder",
        "alt": "Placeholder"
      },
      "attributes": [
      ...
      "_links": {
        "self": [
          {
            "href": "https://example.com/wp-json/wc/v1/products/22/variations/735"
          }
        ],
        "collection": [
          {
    ...
    },
    {
      ...
      "_links": {
        "self": [
          {
            "href": "https://example.com/wp-json/wc/v1/products/22/variations/736"
          }
        ],
        "collection": [
          {
