...
Payhere.post("products/attributes", data)
  .then((response) => {
...
```javascript
Payhere.get("products/attributes/1")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```javascript
Payhere.get("products/attributes")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
Payhere.put("products/attributes/1", data)
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```javascript
Payhere.delete("products/attributes/1", {
  force: true
})
  .then((response) => {
    console.log(response.data);
...
```php
<?php print_r($payhere->delete('products/attributes/1', ['force' => true])); ?>
```
...
```ruby
payhere.delete("products/attributes/1", force: true).parsed_response
```
...
Payhere.post("products/attributes/batch", data)
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
print_r($payhere->post('products/attributes/batch', $data));
?>
```
...
payhere.post("products/attributes/batch", data).parsed_response
```
